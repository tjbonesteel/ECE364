...
Only the 1st occurrance will be changed
"""
...
while Search_String != "Quit":
    ...
    print "replacing the 1st pattern found or"
    ...
    New_String = Reg_Exp.sub(Replacement_String, Search_String, 1)
